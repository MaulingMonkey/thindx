...
impl FunctionDesc<'_> {
    /// ### Safety
    /// Don't dangle any pointers through this now, you hear?!?
    #[doc(hidden)] pub fn as_mut_ptr(&mut self) -> *mut winapi::um::d3d11shader::D3D11_FUNCTION_DESC {
        self as *mut Self as *mut _
    }
}

test_layout! { FunctionDesc => unsafe winapi::um::d3d11shader::D3D11_FUNCTION_DESC {
    version                         => Version,
    creator                         => Creator,
    flags                           => Flags,
