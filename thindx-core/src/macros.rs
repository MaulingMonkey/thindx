#[macro_export] macro_rules! test_layout {
    (
...
pub fn offset_of<S, F>(s: &S, f: &F) -> usize {
    let s : *const S = s;
    let f : *const F = f;
    (f as usize) - (s as usize)
}

#[macro_export] macro_rules! enumish {
...
#[macro_export] macro_rules! flags {
...
#[macro_export] macro_rules! convert {
