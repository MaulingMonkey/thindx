...
/// .get_constant_buffer_by_index(1).get_desc() = Err(MethodErrorBlob { kind: E_FAIL, method: "ID3D11ShaderReflectionConstantBuffer::GetDesc" })
/// 
...
/// .get_constant_buffer_by_name("ExampleCBuffer\u{0}").get_desc() = Err(MethodErrorBlob { kind: E_FAIL, method: "ID3D11ShaderReflectionConstantBuffer::GetDesc" })
/// .get_constant_buffer_by_name("NonExistant").get_desc() = Err(MethodErrorBlob { kind: E_FAIL, method: "ID3D11ShaderReflectionConstantBuffer::GetDesc" })
/// .get_constant_buffer_by_name("").get_desc() = Err(MethodErrorBlob { kind: E_FAIL, method: "ID3D11ShaderReflectionConstantBuffer::GetDesc" })
/// 
...
/// .get_resource_binding_desc(1) = Err(MethodErrorBlob { kind: E_INVALIDARG, method: "ID3D11ShaderReflection::GetResourceBindingDesc" })
/// 
...
/// .get_resource_binding_desc_by_name("ExampleCBuffer\u{0}") = Err(MethodErrorBlob { kind: E_INVALIDARG, method: "ID3D11ShaderReflection::GetResourceBindingDescByName" })
/// .get_resource_binding_desc_by_name("NonExistant") = Err(MethodErrorBlob { kind: E_INVALIDARG, method: "ID3D11ShaderReflection::GetResourceBindingDescByName" })
/// .get_resource_binding_desc_by_name("") = Err(MethodErrorBlob { kind: E_INVALIDARG, method: "ID3D11ShaderReflection::GetResourceBindingDescByName" })
/// 
...
/// .get_variable_by_name("v") = Err(MethodErrorBlob { kind: E_FAIL, method: "ID3D11ShaderReflectionVariable::GetDesc" })
/// .get_variable_by_name("i") = Err(MethodErrorBlob { kind: E_FAIL, method: "ID3D11ShaderReflectionVariable::GetDesc" })
/// .get_variable_by_name("o") = Err(MethodErrorBlob { kind: E_FAIL, method: "ID3D11ShaderReflectionVariable::GetDesc" })
/// .get_variable_by_name("color") = Err(MethodErrorBlob { kind: E_FAIL, method: "ID3D11ShaderReflectionVariable::GetDesc" })
/// ```
///
/// ### To run this example yourself
/// ```cmd
