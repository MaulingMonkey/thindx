...
// d3d9helper.h
const fn MAKE_D3DHRESULT(code: u32) -> ErrorKind { ErrorKind::make_d3dhresult(code) }
const fn MAKE_DDHRESULT (code: u32) -> ErrorKind { ErrorKind::make_ddhresult(code) }
const fn MAKE_D3DSTATUS (code: u32) -> ErrorKind { ErrorKind::make_d3dstatus(code) }
