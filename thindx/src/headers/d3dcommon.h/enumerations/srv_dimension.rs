...
/// \[[microsoft.com](https://learn.microsoft.com/en-us/windows/win32/api/d3dcommon/ne-d3dcommon-d3d_srv_dimension)\]
/// D3D_SRV_DIMENSION
...
#[allow(non_upper_case_globals)] impl SrvDimension { // These are enum-like
    pub const Unknown           : SrvDimension = SrvDimension(D3D_SRV_DIMENSION_UNKNOWN); // 0
