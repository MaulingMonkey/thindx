...
/// \[[microsoft.com](https://learn.microsoft.com/en-us/windows/win32/api/d3dcommon/ne-d3dcommon-d3d_min_precision)\]
/// D3D_MIN_PRECISION
#[derive(Clone, Copy, PartialEq, Eq, PartialOrd, Ord, Hash)]
#[derive(Pod, Zeroable)]
#[repr(transparent)] pub struct MinPrecision(D3D_MIN_PRECISION);

enumish! { MinPrecision => D3D_MIN_PRECISION; default: Default == 0; Default, Float16, Float2_8, Reserved, SInt16, UInt16, Any16, Any10 }

#[allow(non_upper_case_globals)] impl MinPrecision { // These are enum-like
    /// Default minimum precision, which is 32-bit precision.
    pub const Default     : MinPrecision = MinPrecision(D3D_MIN_PRECISION_DEFAULT); // 0
