...
#[cfg(test)] mod vs_d3drect { use super::*; test_layout! { Rect => unsafe D3DRECT { x1 => x1,   y1 => y1,  x2 => x2,    y2 => y2     } } }
#[cfg(test)] mod vs_rect    { use super::*; test_layout! { Rect => unsafe    RECT { x1 => left, y1 => top, x2 => right, y2 => bottom } } }
